 ...
 *
 * In your model overwrite the + (SA_JSONKeyMapper *)keyMapper method and provide a SA_JSONKeyMapper
 * instance to convert the key names for your model.
 *
 * If you need custom mapping it's as easy as:
 * <pre>
 * + (SA_JSONKeyMapper *)keyMapper {
 * &nbsp; return [[SA_JSONKeyMapper&nbsp;alloc]&nbsp;initWithDictionary:@{@"crazy_JSON_name":@"myCamelCaseName"}];
 * }
 * </pre>
 ...
 * </pre>
 */
@interface SA_JSONKeyMapper : NSObject
...
+ (instancetype)mapper:(SA_JSONKeyMapper *)baseKeyMapper withExceptions:(NSDictionary *)exceptions DEPRECATED_MSG_ATTRIBUTE("use baseMapper:withModelToJSONExceptions:");
