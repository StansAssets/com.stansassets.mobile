...
/////////////////////////////////////////////////////////////////////////////////////////////
/** The domain name used for the SA_JSONModelError instances */
extern NSString *const SA_JSONModelErrorDomain;

/**
 * If the model JSON input misses keys that are required, check the
 * userInfo dictionary of the SA_JSONModelError instance you get back -
 ...
 * the SA_JSONModelError instance you get back - under the kJSONModelKeyPath
 ...
 * the common SA_JSONModel errors
 */
@interface SA_JSONModelError : NSError
...
/**
 * Creates a SA_JSONModelError instance with code kJSONModelErrorInvalidData = 1
 */
...
/**
 * Creates a SA_JSONModelError instance with code kJSONModelErrorBadResponse = 2
 */
+ (id)errorBadResponse;

/**
 * Creates a SA_JSONModelError instance with code kJSONModelErrorBadJSON = 3
 */
+ (id)errorBadJSON;

/**
 * Creates a SA_JSONModelError instance with code kJSONModelErrorModelIsInvalid = 4
 */
+ (id)errorModelIsInvalid;

/**
 * Creates a SA_JSONModelError instance with code kJSONModelErrorNilInput = 5
 */
+ (id)errorInputIsNil;

/**
 * Creates a new SA_JSONModelError with the same values plus information about the key-path of the error.
